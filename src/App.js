...
class App extends Component {  
  ...
  render() {
    ...
    const projects = [
    {
      ...
      description: 'Volvo is always striving to create the best customer experience. Thats why we developed an app that would handle everything regarding your car. From insurance to maintenance to controlling it. I was the lead developer in a team of six people.', 
