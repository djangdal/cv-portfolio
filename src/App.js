...
class App extends Component {  
  ...
  render() {
    ...
    const projects = [
    {
      ...
      description: 'Volvo is always striving to create the best customer experience. Thats why we developed an app that would handle everything regarding your car. From insurance to maintenance to controlling it. I was the lead developer in a team of 6 people', 
      ...
      description: 'In conjunction with the new Star Wars movie, Lego wanted to realese a new game containing the new characters and ships from the movie. I was part of a 4 man dev team', 
      ...
      description: 'To join the era of IoT, we created a library to handle the connection between appliances and the mobile phone. I was co-lead on the 5 man iOS team', 
      image: 'electrolux_image.png',
      logo: 'electrolux_logo.png',
      link: null
    },{
      title: 'Founder and Project leader, Monpie Game.', 
      description: 'Together with 5 other people I created a game for iOS that reached first place on App Store with more than 100,000 downloads in 24 hours. I was the founder as well as project leader and lead Developer', 
      ...
      description: 'To make their content available to more people, Discovery created an online streaming service called Dplay available on both mobile and web. I was one of 5 iOS developers', 
    ...
    return (
      <div id="profile-header">
        ...
        <div id="profile-info">
          ...
          <p id="profile-description">Grew up in the cold woods of nothern Sweden, in a town called Luleå. I learned how to shovel snow, handle an axe, drive a snowmobile and fix my car. During the winter we had 3 hours of sunlight, in a month, if lucky. Maybe that's why i developed my interest in computers, well, gaming. I only gained my coding skills from five years of Computer Science and a master in Machine Learning at the <a href="https://www.kth.se/en" rel="noopener noreferrer" target="_blank" id="kth-link"> Royal Institute of technology</a>. These days I'm building more games then I play along with specializing in swift for iOS development, and I love it.</p>
